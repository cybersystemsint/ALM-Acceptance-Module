...
public class DCCViewDTO {
    ...
    private BigDecimal lnUnitPrice;
    ...
    private String poId;
    private BigDecimal UPLACPTRequestValue;
    private BigDecimal POAcceptanceQty;
    private BigDecimal POLineAcceptanceQty;
    private Integer poPendingQuantity;
    ...
    private Integer poOrderQuantity;
    private String poLineDescription;
    private Integer uplLineQuantity;
    ...
    private Integer uplPendingQuantity;
    ...
    public void setLnDeliveredQty(Integer lnDeliveredQty) {
    ...
    public BigDecimal getLnUnitPrice() {
        return lnUnitPrice;
    }

    public void setLnUnitPrice(BigDecimal lnUnitPrice) {
    ...
    public BigDecimal getUPLACPTRequestValue() {
        return UPLACPTRequestValue;
    }

    public void setUPLACPTRequestValue(BigDecimal UPLACPTRequestValue) {
        this.UPLACPTRequestValue = UPLACPTRequestValue;
    }

    public BigDecimal getPOAcceptanceQty() {
        return POAcceptanceQty;
    }

    public void setPOAcceptanceQty(BigDecimal POAcceptanceQty) {
        this.POAcceptanceQty = POAcceptanceQty;
    }

    public BigDecimal getPOLineAcceptanceQty() {
        return POLineAcceptanceQty;
    }

    public void setPOLineAcceptanceQty(BigDecimal POLineAcceptanceQty) {
        this.POLineAcceptanceQty = POLineAcceptanceQty;
    }

    public Integer getPoPendingQuantity() {
        return poPendingQuantity;
    }

    public void setPoPendingQuantity(Integer poPendingQuantity) {
    ...
    public Integer getUplPendingQuantity() {
        return uplPendingQuantity;
    }

    public void setUplPendingQuantity(Integer uplPendingQuantity) {
