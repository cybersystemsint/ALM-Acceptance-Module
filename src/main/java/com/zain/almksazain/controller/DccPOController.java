...
public class DccPOController {
    ...
    public DeferredResult<ResponseEntity<DccPOResponseDTO>> getDccPOCombinedView(
        ...
        logger.info("ALM | Acceptance Module | fetching payload: {} ", request);
        try {
    ...
    //                                        lineItem.setPOAcceptanceQty(dto.getPOAcceptanceQty());
            ...
            logger.error("Error fetching acceptance requests ", e);
            logger.info("ALM | Acceptance Module | error: {} ", e.getMessage());
            return null;
        }
    }
